...
// CoupleResultContent를 dynamic import로 lazy load하여 초기 번들 크기 감소
// 대형 정적 데이터 파일(saju-analysis-data 등)이 분리됨
const CoupleResultContent = dynamic(
  () => import("@/components/saju/CoupleResultContent").then((mod) => mod.CoupleResultContent),
  {
    loading: () => <LoadingCard />,
